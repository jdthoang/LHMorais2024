...
target_sheet_name <- "CII_Striatum"
...
variable = 'CII_Striatum_Uncoupled'
effect_1 = 'Microbiome'
effect_2 = 'Genotype'
groups = 'Group'
...
ggplot(data, aes(x = eval(as.name(groups)), y = eval(as.name(variable)))) +
  ...
  labs(x = NULL, y = "OCR (pmol/sec)", title = "CII Striatum Uncoupled") +
...
write.csv(lv_mod1_params, 
          file = file.path("..", 
                           "Output", 
                           glue("lmTotalSeahorse_CII_Striatum_Uncoupled-{Sys.Date()}-params.csv")),
          quote = FALSE)
...
write.csv(lv_mod1_contrasts, 
          file = file.path("..", 
                           "Output", 
                           glue("lmTotalSeahorse_CII_Striatum_Uncoupled-{Sys.Date()}.csv")),
          quote = FALSE)
```
