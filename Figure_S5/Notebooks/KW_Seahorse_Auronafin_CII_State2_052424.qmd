...
kruskwall_output <- file.path("..", "..", "..",  "Output", "Seahorse_Auranofin", "CII", glue("KW_CII_State2-{Sys.Date()}-kruskal.txt"))
...
if (kruskal_result$p.value < 0.05) {
  ...
  file_name <- file.path("..", "..", "..",  "Output", "Seahorse_Auranofin", "CII", glue("KW_CII_State2-{Sys.Date()}-pairwise.txt"))
