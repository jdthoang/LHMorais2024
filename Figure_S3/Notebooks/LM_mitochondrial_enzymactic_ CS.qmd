...
ggplot(data, aes(x = eval(as.name(groups)), y = eval(as.name(variable)))) +
  ...
  labs(x = NULL, y = "Citrate synthase total activity") +
...
ggplot(data, 
  ...
  labs(title = "ECDF of citrate synthase activity",
       y = NULL,
       x = "Citrate synthase total activity",
       color = groups) +
  theme_light()
```
